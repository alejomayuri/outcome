export default function Hero() {
    return (
      <section className="relative">
        ...
        <div className="md:absolute left-1/2 bottom-0 md:transform md:-translate-x-1/2 md:translate-y-1/2 bg-black text-white px-6 md:px-10 py-6 w-full max-w-4xl shadow-lg border-t-20 border-purple-500">
